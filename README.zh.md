...
### [我的博客在这里 &rarr;](http://guozhao.page.github.io)
...
sidebar-avatar: /img/my-avatar.jpg     #你的大头贴，请使用绝对地址.
```
...
ga_domain: guozhao265.me			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
